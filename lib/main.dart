...
import 'package:sneak_crib/repository.dart';
import 'package:sneak_crib/login.dart';
import 'package:sneak_crib/contactus.dart';
import 'package:sneak_crib/signup.dart';
...
class _NikeShoesHomeState extends State<NikeShoesHome> {
  ...
  void initState() {
    ...
    //active product
    _activeProduct = repository
        .firstProductInGroup(productGroups.elementAt(_activeProductGroupIndex));
      ...
      child: SizedBox(
        ...
        child: PageView.builder(
          ...
          itemBuilder: (context, index) {
            return _activeProductGroupIndex == index
                ? _activeProductItem()
                : _productItem(index);
          },
        ),
        ...
        children: [
          ...
          Align(
            ...
            child: Container(
              ...
              child: Transform.rotate(
                angle: -math.pi / 6,
                child: Image.asset(repository
                    .firstProductInGroup(productGroups.elementAt(index))
                    .url),
              ),
            ),
          ),
